    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="fixed top-6 left-6 z-50">
          <a href="/" className="text-4xl font-cursive italic tracking-wide">
            Kurtify
          </a>
        </div>
        ...
        <section className="py-32 px-6 lg:px-12 max-w-7xl mx-auto ">
          <div className="text-center mb-20">
            <p className="text-sm tracking-widest uppercase mb-4">Collections</p>
        ...
        {/* Newsletter */}
        <section className="py-32 px-6 text-white bg-black">
          <div className="max-w-2xl mx-auto text-center border border-white/40 p-16">
            <h3 className="text-4xl font-serif-elegant mb-6">Stay Connected</h3>
            <p className="font-cursive italic text-xl text-white/40 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="flex-1 bg-transparent border border-white/30 px-6 py-4 focus:outline-none focus:border-black transition-colors text-center sm:text-left"
              />
              <button className="bg-black text-white px-8 py-4 hover:bg-white/90 hover:text-black transition-all duration-300 uppercase tracking-widest text-sm font-light">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <footer className="border-t border-white/10 py-16 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
              ...
              <div>
                <h5 className="text-sm uppercase tracking-widest mb-6 text-white/40">Shop</h5>
            ...
            <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-white/30 tracking-widest uppercase">
              <p>© 2025 Kurtify. All Rights Reserved.</p>
              {healthCheck.data && (
